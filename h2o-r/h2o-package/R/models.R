...
#' Predict class probabilities at each stage an H2O Model
#'
...
#' predicted probability of this class by combining contributions of trees T1.Cc,..,TtCc. Binomial models build
